...
const AudioPlayer: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br  p-6">
      <div className="w-full max-w-2xl p-8 rounded-lg shadow-2xl bg-gray-900 border border-gray-600 transition-all hover:border-blue-700 hover:shadow-blue-950">
        ...
        <Card className="shadow-lg rounded-lg bg-red-900 backdrop-blur-sm transition-all duration-300 ease-in-out hover:scale-105">
      ...
      <footer className="mt-4 text-sm text-gray-400 text-center">
        Created By <span className="text-yellow-300">{`abdul rehman`}</span>
      </footer>
    </div>
  );
}
